...
import org.iesalixar.daw2.alvarolabradorgarcia.dwese_ticket_logger_webapp.dao.RegionDAO;
...
public class RegionController {
    ...
    public String deleteRegion(@RequestParam("id") int id, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            logger.error("No se puede eliminar la región con ID {}: {}", id, e.getMessage());
            redirectAttributes.addFlashAttribute("errorMessage", "No se puede eliminar la región porque está vinculada a una provincia.");
        } catch (SQLException e) {
